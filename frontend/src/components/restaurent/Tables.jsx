...
function Tables() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/restaurent-api/all`)
  ...
  useEffect(() => {
    if (selectedRestaurant) {
      axios
        .get(`${import.meta.env.VITE_BACKEND_URL}/table-api/bookings`, {
  ...
  const handleTableClick = async (index) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/table-api/book-table`, bookingData);
